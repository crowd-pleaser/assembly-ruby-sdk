...
bank_account_request_body = OpenapiClient::BankAccountRequestBody.new # BankAccountRequestBody | 
...
api_instance = OpenapiClient::BankAccountsApi.new
id = 'aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee' # String | Bank account ID
penny_verify_request_body = OpenapiClient::PennyVerifyRequestBody.new # PennyVerifyRequestBody | 
