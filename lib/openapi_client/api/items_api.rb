...
module OpenapiClient
  class ItemsApi
    ...
    def create_item_with_http_info(item_request_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(item_request_body) 
    ...
    def list_item_batch_transactions_with_http_info(id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'ListBatchTransactions' 
    ...
    def show_item_fees_with_http_info(id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'Fees' 
    ...
    def show_item_status_with_http_info(id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'SingleStatus' 
    ...
    def show_item_wire_details_with_http_info(id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'SingleWireDetailsWithId' 
    ...
    def update_item_with_http_info(id, update_item_request_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(update_item_request_body) 
