...
module OpenapiClient
  class CompaniesApi
    ...
    def create_company_with_http_info(company_request_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(company_request_body) 

      # return_type
      return_type = opts[:return_type] || 'SingleCompany' 
    ...
    def list_companies_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'SimpleCompanies' 
