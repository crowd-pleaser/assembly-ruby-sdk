...
module OpenapiClient
  class CardAccountsApi
    ...
    def create_card_account_with_http_info(card_account_request_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(card_account_request_body) 
    ...
    def redact_card_account_with_http_info(id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'CardAccountDeletion' 
    ...
    def verify_card_with_http_info(id, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'card_account_verify_request_body']) 
