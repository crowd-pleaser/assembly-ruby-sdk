...
module OpenapiClient
  class UsersApi
    ...
    def create_user_with_http_info(user_request_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(user_request_body) 
    ...
    def list_user_b_pay_accounts_with_http_info(id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'ListBpayAccounts' 
    ...
    def set_user_disbursement_account_with_http_info(id, bank_account_id_request_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(bank_account_id_request_body) 
    ...
    def show_user_card_account_with_http_info(id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'CardAccount' 
    ...
    def update_user_with_http_info(id, update_user_request_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(update_user_request_body) 
