...
module OpenapiClient
  class WalletAccountsApi
    ...
    def bill_payment_with_http_info(id, bill_payment_request_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(bill_payment_request_body) 
    ...
    def deposit_funds_with_http_info(id, deposit_request_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(deposit_request_body) 
    ...
    def show_wallet_account_nbpay_details_with_http_info(id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'WalletAccountBpayDetails' 
    ...
    def show_wallet_account_npp_details_with_http_info(id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'WalletAccountNppDetails' 
    ...
    def withdraw_funds_with_http_info(id, withdraw_request_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(withdraw_request_body) 
