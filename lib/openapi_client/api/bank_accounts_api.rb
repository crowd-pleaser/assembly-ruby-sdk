...
module OpenapiClient
  class BankAccountsApi
    ...
    def create_bank_account_with_http_info(bank_account_request_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(bank_account_request_body) 
    ...
    def redact_bank_account_with_http_info(id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'BankAccountDeletion' 
    ...
    def validate_routing_number_with_http_info(routing_number, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'SingleRoutingNumber' 
    ...
    def verify_penny_amount_with_http_info(id, penny_verify_request_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(penny_verify_request_body) 
